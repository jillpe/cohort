...
#     path('about/', views.about, name='about'),
    ...
    path('applicants/<int:user_id>', views.applicants_detail, name='applicants_detail'),
    path("jobtitles/<int:user_id>/assoc_job/<int:jobtitle_id>/",views.assoc_job, name="assoc_job",),
    path("jobtitles/<int:user_id>/unassoc_job/<int:jobtitle_id>/",views.unassoc_job, name="unassoc_job",),
